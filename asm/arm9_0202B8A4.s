...
sub_0202C8B0: ; 0x0202C8B0
	...
	ldr ip, _0202C8CC ; =_ZN17UnkClass_020091E812sub_02009ECCEv
	ldr r0, [r0]
	add r0, r0, #0x1000
	ldr r0, [r0, #0x490]
	bx ip
...
sub_0202C974: ; 0x0202C974
	...
	add r0, r2, #0x1000
	ldr r0, [r0, #0x490]
	bl _ZN17UnkClass_020091E812sub_0200AA28El
	mov r0, #0
	ldmia sp!, {r3, pc}
	.align 2, 0
...
sub_0202C99C: ; 0x0202C99C
	...
	add r0, r0, #0x1000
	ldr r0, [r0, #0x490]
	bl _ZN17UnkClass_020091E812sub_0200AA38Ev
	mov r0, #0
	ldmia sp!, {r3, pc}
	.align 2, 0
...
sub_0202C9C0: ; 0x0202C9C0
	...
	add r0, r2, #0x1000
	ldr r0, [r0, #0x490]
	bl _ZN17UnkClass_020091E812sub_0200AA48El
	mov r0, #0
	ldmia sp!, {r3, pc}
	.align 2, 0
...
sub_0202C9E8: ; 0x0202C9E8
	...
	add r0, r0, #0x1000
	ldr r0, [r0, #0x490]
	bl _ZN17UnkClass_020091E812sub_0200AA58Ev
	mov r0, #0
	ldmia sp!, {r3, pc}
	.align 2, 0
...
_0203F91C:
	...
	bl _Z12sub_02006C0411PointPair2D9RectangleP7Point2D
	cmp r0, #0
	beq _0203FB58
	mov r0, #0x14
	mul r0, r6, r0
...
_0203FDB4:
	...
	ldr r3, [r8]
	ldmia r0, {r0, r1, r2}
	bl _Z12sub_02006E306Circle9RectangleP7Point2Dl
	cmp r0, #0
	beq _0203FE28
	ldr r0, [sp, #0xb68]
	cmp r0, #0
...
_02040280:
	...
	ldr r3, [r5]
	ldmia r7, {r0, r1, r2}
	bl _Z12sub_02006F806Circle9Rectangle
	cmp r0, #0
	beq _02040360
	add sp, sp, #0x34
	mov r0, #1
