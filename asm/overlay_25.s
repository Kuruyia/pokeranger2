    ...
    .include "asm/include/overlay_25.inc"

    .text

	arm_func_start ov25_0211C9E0
ov25_0211C9E0: ; 0x0211C9E0
	stmdb sp!, {r4, lr}
	mov r4, r0
	bl sub_02007C98
...
ov25_0211CA54: ; 0x0211CA54
	...
	ldr r4, _0211CEC8 ; =MAIN_BSS_0208F304
	mov r7, #0
	mov r5, #2
	mov fp, sl
	mov r6, #5
...
_0211CB70:
	ldr r1, [sb, #0x2c]
	ldr r0, _0211CEC8 ; =MAIN_BSS_0208F304
	add r1, r1, #1
	str r1, [sb, #0x2c]
	ldr r0, [r0]
	ldr r1, [sb, #4]
...
_0211CD48:
	cmp r7, #0x45
	bne _0211CEA8
	ldr r1, _0211CEC8 ; =MAIN_BSS_0208F304
...
_0211CEC8: .word MAIN_BSS_0208F304
...
ov25_0211D098: ; 0x0211D098
	stmdb sp!, {r4, r5, r6, r7, r8, sb, sl, fp, lr}
	sub sp, sp, #0x4c
	ldr r1, _0211D38C ; =MAIN_BSS_0208F304
	mov sl, r0
	ldr r0, [r1]
	mov r1, #0x3c
	add r0, r0, #0x6c
	...
	str r1, [sl, #4]
	str r1, [sl, #8]
	ldr r0, _0211D38C ; =MAIN_BSS_0208F304
	str r1, [sl, #0xc]
	ldr r0, [r0]
	mov r1, #3
	add r0, r0, #0x1000
...
_0211D374:
	...
	ldmia sp!, {r4, r5, r6, r7, r8, sb, sl, fp, pc}
	.align 2, 0
_0211D38C: .word MAIN_BSS_0208F304
...
_0211D468:
	...
	str r0, [r4, #0x14]
_0211D470:
	ldr r0, _0211D4D8 ; =MAIN_BSS_0208F304
	ldr r0, [r0]
	add r0, r0, #0x1000
	ldr r0, [r0, #0x490]
	bl sub_0200AC90
...
_0211D4CC:
	...
	.align 2, 0
_0211D4D8: .word MAIN_BSS_0208F304
...
ov25_0211F750: ; 0x0211F750
	...
	beq _0211F794
	mov r2, #0x40
	ldr r1, _0211F834 ; =MAIN_BSS_0208F304
	str r2, [sp]
	ldr r1, [r1]
	mov r2, #0
	add r1, r1, #0x24
...
_0211F794:
	...
	ldmia sp!, {r3, r4, pc}
	.align 2, 0
_0211F834: .word MAIN_BSS_0208F304
