    ...
    .include "asm/include/overlay_01.inc"
...
_0211DD98:
	...
	add r0, r0, #0x1000
	bl sub_02045A18
	bl NitroSystem_gfd_VramManager_NNS_GfdDumpLnkTexVramManager
	bl NitroSystem_gfd_VramManager_NNS_GfdDumpLnkPlttVramManager
	add sp, sp, #0x198
...
_02123E98:
	...
	ldr r0, [r2, #0x20]
	ldr ip, [r2, #0x1c]
	ldr r2, _02124024 ; =DAT_020850ac
	str r0, [sp, #0xc]
	str r0, [sp, #0x1c]
	mov r0, r1, lsl #1
	add r1, r2, r1, lsl #1
	ldrsh r2, [r1, #2]
	ldr r1, _02124024 ; =DAT_020850ac
	ldr lr, [sb, #0x4a8]
	ldrsh r1, [r1, r0]
	smull r3, sl, lr, r2
	smull r2, r1, lr, r1
...
ov1_02137F80: ; 0x02137F80
	...
	bl MSL_C_printf_printf
	bl MSL_C_abort_exit_abort
...
_0213FA6C:
	...
	ldr r1, [r5, #0x50]
	bl DC_FlushRange
	bl NitroSDK_gx_GX_BeginLoadTexPltt
	ldr r0, [r5, #0x4c]
	ldr r1, [r7, #0xc]
	mov r2, r6
	bl NitroSDK_gx_GX_LoadTexPltt
	bl NitroSDK_gx_GX_EndLoadTexPltt
	ldr r0, [r4, #0x4c]
	ldr r1, [r4, #0x50]
	bl DC_FlushRange
	bl NitroSDK_gx_GX_BeginLoadTex
	ldr r1, [r7, #8]
	ldr r0, [r4, #0x4c]
	ldr r2, [r4, #0x50]
	bl NitroSDK_gx_GX_LoadTex
	bl NitroSDK_gx_GX_EndLoadTex
	cmp r4, #0
	beq _0213FB28
	mov r0, r4
	ldr r1, [r0]
