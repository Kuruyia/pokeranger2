...
void CPrimitiveRECT::SetVertexCoordinates(fx32 x1, fx32 y1, fx32 x2, fx32 y2, fx32 z)
{
    m_vtxCoords.x1 = x1;
    m_vtxCoords.y1 = y1;
    m_vtxCoords.x2 = x2;
...
void CPrimitiveRECT::sub_02003C00(UnkClass_CPrimitiveRECT_02003C00 *arg0, CPrimitiveRECT *arg1)
{
    ...
    fx32 v1 = arg1->m_vtxCoords.x1;
    fx32 v2 = arg1->m_vtxCoords.y1;
...
u32 CPrimitiveRECT::RenderWithTexture(CPrimitive_Render_arg *arg0)
{
    ...
    G3_Vtx(FX_Whole(m_vtxCoords.x1 - vtxX2) << v2, FX_Whole(m_vtxCoords.y1 - vtxY2) << v2, m_z);

    G3_TexCoord(m_texCoords.x1, m_texCoords.y2);
    G3_VtxXY(FX_Whole(m_vtxCoords.x1 - vtxX2) << v2, FX_Whole(m_vtxCoords.y1 + vtxY2) << v2);
...
u32 CPrimitiveRECT::RenderWithoutTexture(CPrimitive_Render_arg *arg0)
{
    ...
    fx32 vtxX2 = m_vtxCoords.x2 / 2;
    fx32 vtxY2 = m_vtxCoords.y2 / 2;
    ...
    G3_Vtx(FX_Whole(m_vtxCoords.x1 - vtxX2) << v0, FX_Whole(m_vtxCoords.y1 - vtxY2) << v0, m_z);
    G3_VtxXY(FX_Whole(m_vtxCoords.x1 - vtxX2) << v0, FX_Whole(m_vtxCoords.y1 + vtxY2) << v0);
    G3_VtxXY(FX_Whole(m_vtxCoords.x1 + vtxX2) << v0, FX_Whole(m_vtxCoords.y1 + vtxY2) << v0);
    G3_VtxXY(FX_Whole(m_vtxCoords.x1 + vtxX2) << v0, FX_Whole(m_vtxCoords.y1 - vtxY2) << v0);
